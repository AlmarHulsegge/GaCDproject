Codebook for Getting and Cleabing Data, week 4, course project
...
The experiment leading to the "Human Activity Recognition Using Smartphones Dataset"
...
The measurements on the mean and standard deviation are being extracted (whilst also keeping the variables for activity and subject).
The activity numbers are being replaced with the appropriate labels.
The variable names are being cleaned up from special characters and are being made more descriptive.
